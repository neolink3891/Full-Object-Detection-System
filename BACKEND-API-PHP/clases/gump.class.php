<?php
//if (!defined('G5'))die('Acceso no permitido.');
...
class GUMP
{
    ...
    public function get_readable_errors($convert_to_string = false, $field_class = 'gump-field', $error_class = 'gump-error-message')
    {
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                case 'mismatch' :
                    $resp[] = "No hay una regla de validacion valida para  <span class=\"$field_class\">$field</span>";
                    break;
                case 'validate_required' :
                    $resp[] = "El campo <span class=\"$field_class\">$field</span>  es obligatorio";
                    break;
                case 'validate_valid_email':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe ser una direccion de correo valida";
                    break;
                case 'validate_max_len':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe ser $param o más corto en longitud";
                    break;
                case 'validate_min_len':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span>  debe ser $param o mas largo en longitud";
                    break;
                case 'validate_exact_len':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe tener exactamente $param carcateres de longitud";
                    break;
                case 'validate_alpha':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe contener unicamente carcateres alfabeticos(a-z)";
                    break;
                case 'validate_alpha_numeric':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe contener unicamente caracteres alfa-numericos(a-z)(0-9)";
                    break;
                case 'validate_alpha_dash':
                    $resp[] = "El campo<span class=\"$field_class\">$field</span> solo puede contener caracteres alfanumericos  incluido guiones";
                    break;
                case 'validate_numeric':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> solo puede contener caracteres numericos(0-10)(0.0-10.0)";
                    break;
                case 'validate_integer':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> solo puede contener numeros enteros(0-10)";
                    break;
                case 'validate_boolean':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe contener un valor verdadero o falso";
                    break;
                case 'validate_float':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> solo puede contener un valor decimal";
                    break;
                case 'validate_valid_url':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> requiere una URL valida";
                    break;
                case 'validate_url_exists':
                    $resp[] = "la direccion <span class=\"$field_class\">$field</span> No existe";
                    break;
                case 'validate_valid_ip':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> necesita contener una direccion ip valida";
                    break;
                case 'validate_valid_cc':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> necesita contener un numero de tarjeta de credito valido";
                    break;
                case 'validate_valid_name':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe ser un nombre de persona valido";
                    break;
                case 'validate_contains':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe contener uno de los siguiente valores: " . implode(', ', $param);
                    break;
                case 'validate_contains_list':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe contener unicamente un valor de la lista";
                    break;
                case 'validate_doesnt_contain_list':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> contiene un valor no aceptado";
                    break;
                case 'validate_street_address':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe ser una direccion valida";
                    break;
                case 'validate_date':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe ser una fecha valida";
                    break;
                case 'validate_min_numeric':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe contener un valor numerico, igual o mayor que $param";
                    break;
                case 'validate_max_numeric':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe contener un valor numerico menor o igual que $param";
                    break;
                case 'validate_starts':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe empezar con $param";
                    break;
                case 'validate_extension':
                    $resp[] = "El campo <span class\"$field_class\">$field</span> debe contener la siguiente extension $param";
                    break;
                case 'validate_required_file':
                    $resp[] = "El campo <span class\"$field_class\">$field</span> es obligatorio";
                    break;
                case 'validate_equalsfield':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> deb ser igual al  campo $param";
                    break;
                case 'validate_min_age':
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> debe ser una edad igual o mayor a $param";
                    break;
                default:
                    $resp[] = "El campo <span class=\"$field_class\">$field</span> es invalido";
            }
        }
    ...
    public function get_errors_array($convert_to_string = null)
    {
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                case 'mismatch' :
                    $resp[$field] = "No hay una regla de validacion valida para  $field";
                    break;
                case 'validate_required':
                    $resp[$field] = "El campo $field es obligatorio";
                    break;
                case 'validate_valid_email':
                    $resp[$field] = "El campo $field debe ser una direccion de correo valida";
                    break;
                case 'validate_max_len':
                    $resp[$field] = "El campo  $field debe ser $param o más corto en longitud";
                    break;
                case 'validate_min_len':
                    $resp[$field] = "El campo $field debe ser $param o mas largo en longitud";
                    break;
                case 'validate_exact_len':
                    $resp[$field] = "El campo $field debe tener exactamente $param carcateres de longitud";
                    break;
                case 'validate_alpha':
                    $resp[$field] = "El campo $field debe contener unicamente carcateres alfabeticos(a-z)";
                    break;
                case 'validate_alpha_numeric':
                    $resp[$field] = "El campo $field debe contener unicamente caracteres alfa-numericos(a-z)(0-9)";
                    break;
                case 'validate_alpha_dash':
                    $resp[$field] = "El campo $field solo puede contener caracteres alfanumericos  incluido guiones";
                    break;
                case 'validate_numeric':
                    $resp[$field] = "El campo $field solo puede contener caracteres numericos(0-10)(0.0-10.0)";
                    break;
                case 'validate_integer':
                    $resp[$field] = "el campo $field solo puede contener numeros enteros(0-10)";
                    break;
                case 'validate_boolean':
                    $resp[$field] = "El campo $field debe contener un valor verdadero o falso";
                    break;
                case 'validate_float':
                    $resp[$field] = "El campo $field solo puede contener un valor decimal";
                    break;
                case 'validate_valid_url':
                    $resp[$field] = "El campo $field requiere una URL valida";
                    break;
                case 'validate_url_exists':
                    $resp[$field] = "La direccion $field No existe";
                    break;
                case 'validate_valid_ip':
                    $resp[$field] = "El campo $field necesita contener una direccion ip valida";
                    break;
                case 'validate_valid_cc':
                    $resp[$field] = "El campo $field necesita contener un numero de tarjeta de credito valido";
                    break;
                case 'validate_valid_name':
                    $resp[$field] = "El campo $field debe ser un nombre de persona valido";
                    break;
                case 'validate_contains':
                    $resp[$field] = "El campo  $field debe contener uno de los siguiente valores: " . implode(', ', $param);
                    break;
                case 'validate_street_address':
                    $resp[$field] = "El campo $field debe ser una direccion valida";
                    break;
                case 'validate_date':
                    $resp[$field] = "El campo $field debe ser una fecha valida";
                    break;
                case 'validate_min_numeric':
                    $resp[$field] = "El campo $field debe contener un valor numerico, igual o mayor que $param";
                    break;
                case 'validate_max_numeric':
                    $resp[$field] = "El campo $field debe contener un valor numerico menor o igual que $param";
                    break;
                case 'validate_min_age':
                    $resp[$field] = "El campo $field debe ser una edad igual o mayor a $param";
                    break;
                default:
                    $resp[$field] = "El campo $field es invalido";
            }
        }
